...
export async function PollDetails({ params }: { params: Promise<{ pollId: string }> }) {
  ...
  if (!options || !answers?.length) return <div className="h-full flex justify-center items-center">Ninguém participou da enquete</div>
